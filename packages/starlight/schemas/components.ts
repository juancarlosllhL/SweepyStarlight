	...
	return z
		.object({
			...
			*/
			 ...
			 */
			Head: z.string().default('@lansweeper/sweepy-starlight/components/Head.astro'),
			...
			*/
			 ...
			 */
			SkipLink: z.string().default('@lansweeper/sweepy-starlight/components/SkipLink.astro'),
			...
			*/
			 ...
			 */
			PageFrame: z.string().default('@lansweeper/sweepy-starlight/components/PageFrame.astro'),
			/**
			...
			*/
			 ...
			 */
			Header: z.string().default('@lansweeper/sweepy-starlight/components/Header.astro'),
			/**
			 ...
			 */
			SiteTitle: z.string().default('@lansweeper/sweepy-starlight/components/SiteTitle.astro'),
			/**
			 ...
			 */
			Search: z.string().default('@lansweeper/sweepy-starlight/components/Search.astro'),
			/**
			 ...
			 */
			SocialIcons: z.string().default('@lansweeper/sweepy-starlight/components/SocialIcons.astro'),
			/**
			...
			*/
			 ...
			 */
			PageSidebar: z.string().default('@lansweeper/sweepy-starlight/components/PageSidebar.astro'),
			/**
			...
			MobileTableOfContents: z
				.string()
				.default('@lansweeper/sweepy-starlight/components/MobileTableOfContents.astro'),
			...
			*/
			 ...
			 */
			Banner: z.string().default('@lansweeper/sweepy-starlight/components/Banner.astro'),
			 ...
			 */
			Hero: z.string().default('@lansweeper/sweepy-starlight/components/Hero.astro'),
			...
			*/
			 ...
			 */
			Footer: z.string().default('@lansweeper/sweepy-starlight/components/Footer.astro'),
			/**
			 ...
			 */
			LastUpdated: z.string().default('@lansweeper/sweepy-starlight/components/LastUpdated.astro'),
			/**
			 ...
			 */
			Pagination: z.string().default('@lansweeper/sweepy-starlight/components/Pagination.astro'),
			/**
			 ...
			 */
			EditLink: z.string().default('@lansweeper/sweepy-starlight/components/EditLink.astro'),
		})
		.default({});
}
